...
@app.cell
def __(datetime, np, pl, random, timedelta):
...
def __(pl, sales_df):
    ...
    return pivot_region_year, pivot_region_year_display
...
def __(pl, sales_df):
    ...
    return pivot_product_region, pivot_product_region_display
...
def __(pl, sales_df):
    ...
    pivot_product_quarter_display = pivot_product_quarter_display.with_columns([
        pl.col(f"Q{q}_avg").round(2) for q in range(1, 5)
    ])

    pivot_product_quarter_display
    return pivot_product_quarter, pivot_product_quarter_display
...
def __(pl, sales_df):
    ...
    return pivot_quantity, pivot_quantity_display
...
def __(pl, sales_df):
    ...
    return laptop_sales, pivot_laptop_monthly, pivot_laptop_monthly_display
...
def __(pl, sales_df):
    ...
    return pivot_complex, pivot_complex_display
...
def __(mo, pl, sales_df):
    ...
    return avg_transaction, num_transactions, total_revenue, total_units
