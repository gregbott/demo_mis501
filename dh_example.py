...
def _():
    ...
    # Alice computes the remainder using g raised to her secret number mod p
    alice_shared = q**alice_secret % p
    print(f'Alice gives Bob this number: {q}^{alice_secret} % {p} = {alice_shared}\n')
    return alice_secret, alice_shared, bob_secret, p, q


@app.cell
def _(bob_secret, p, q):
...
@app.cell
def _(alice_secret, alice_shared, bob_secret, bob_shared, p):
    ...
    return key_for_alice, key_for_bob


@app.cell
def _(key_for_alice, key_for_bob):
